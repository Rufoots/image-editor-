...
class Operations:
    ...
    def __str__(self):
        return f"size: {self.size}, filter: {self.color_filter}, detection: {self.detect}, " \
...
def _get_img_with_all_operations():
    ...
    if operations.detect:
        logger.debug("tried")
        img = img_helper.detect(img)
...
class ActionTabs(QTabWidget):
    ...
    def __init__(self, parent):
        ...
        self.addTab(self.detection_tab, "Detection")
...
class DetectionTab(QWidget):
    def __init__(self, parent):
        ...
        detect_btn.setMinimumWidth(BTN_MIN_WIDTH)
    ...
    def detect(self):
        logger.debug(f"Facial Recognition Selected")
        operations.detect = True
...
class MainLayout(QVBoxLayout):
    ...
    def __init__(self, parent):
        ...
        self.img_lbl = QLabel("Press <b>'Upload'</b> to to start<br>"
                              ...
                              "<b>made by </b> <span style='color:red'>Aditya, Ritwik & Vedant</span>")
        ...
        capture_btn.setMinimumWidth(BTN_MIN_WIDTH)
        capture_btn.clicked.connect(self.on_capture)
        capture_btn.setStyleSheet("font-weight:bold;")
